...
- **One action: open P2 — Plan staging mode (2D furnishing)** ([`2026-08-18-P2-plan-staging.md`](../plans/2026-08-18-P2-plan-staging.md)) — P7 is closed (all increments shipped 2026-08-23) and the execution order resumes at P2, which was approved and depends on P1 (shipped). P3 stays last; P4/P5 remain unscheduled. The P7.6 tree (uncommitted: 193 modified + 58 renamed paths) is the full P7 delta on top of `2708e94` (P7.3) — commit or review it before branching into P2.
