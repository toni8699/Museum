...
- Attribution (optional under CC0): “Dining Chair 02” by James Ray Cock / Poly Haven.
...
- Source bounds: approximately 0.43 × 0.97 × 0.58 metres; manifest scale `0.92` produces approximately 0.40 × 0.90 × 0.53 metres.

The source files are retained separately and are never loaded by the production app.
