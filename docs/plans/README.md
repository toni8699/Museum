...
| P16 | project-model + layout-core extraction — slice 2 of the ratified migration review: extract pure project/scene/layout documents, codecs, room semantics, compiled geometry, package format, and SHA primitives behind shared packages; preserve canonical JSON, generated-endpoint, graph, geometry, editor, visitor, and relic behavior | **proposed — plan drafted 2026-08-30; owner approval required** | P15 | [2026-08-30-P16-project-model-layout-core-extraction.md](2026-08-30-P16-project-model-layout-core-extraction.md) |
...
migration review** — the first step toward the editor/visitor/api split.
