...
**Asset policy:** packages contain no user binary assets — scene entities reference shipped catalogue `assetId`s only; project-local GLB import + account persistence are deferred (tracker P4).
