...
**Status:** Active release authority. Phase 3 is complete through Slice 3.1.
**Baseline:** `main` at `51947b3`; Phase 3.1 is uncommitted. Preserve it. Do not commit unless requested.
