# P3B — Shipped Groups A + B (archived)

**Date:** 2026-08-24 (created) · **Archived:** 2026-08-25
**Status:** Shipped — Group A (Plan-surface parity) and Group B (Scene 3D
orientation utility, P3B.1–P3B.4) are complete. Extracted from the live P3B
plan so the active doc stays focused on Group C → Core QA → Deferred tail.
**Live plan:** `docs/plans/2026-08-24-P3B-orientation-preview-affordances.md`
**Tracker:** `docs/plans/README.md` — P3B

Shipped history:

- Group A — Plan-surface parity (P3B.4a → P3B.4b): shipped 2026-08-24
- Group B — Scene 3D orientation utility:
  - P3B.1 cardinal snap authority: shipped 2026-08-24
  - P3B.2 projection/rendering: shipped 2026-08-24
  - P3B.3 interaction states: shipped 2026-08-25
  - P3B.4 cardinal snap motion: shipped 2026-08-25
...
# Shipped Definition of Done — Group A + Group B
