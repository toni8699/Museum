...
| P20 | Project Asset Registry + R2 — durable project-scoped texture assets, authenticated storage, Spatial integration, portable package fidelity, and refresh/Load resolution | proposed — blocked on P19 shipped | P19 | [2026-08-19-P20-Project-assets-registry-R2.md](2026-08-19-P20-Project-assets-registry-R2.md) |
