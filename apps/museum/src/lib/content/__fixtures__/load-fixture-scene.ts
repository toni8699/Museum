 ...
 * this instead of the live `museum-scene.json` singleton.
 */
...
export function cloneFixtureDocument(name: FixtureSceneName = 'tour-minimal'): MuseumSceneDocument {
	return JSON.parse(JSON.stringify(loadFixtureScene(name).document)) as MuseumSceneDocument;
}
