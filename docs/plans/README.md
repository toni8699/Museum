...
| P19 | first project persistence — authenticated semantic-document Save/Load, immutable project versions, and single-user ownership on the P18 API/Neon boundary | in-progress — Google OIDC/live deployment gate remains | P18 | [2026-08-30-P19-project-persistence.md](2026-08-30-P19-project-persistence.md) |
