...
**Local-first workflow:** New Project → layout in Plan → generated 3D → scene/assets → camera tour → export one portable project package → later import it to resume. Saving does not require modifying repository source files.
