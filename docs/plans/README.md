...
| P12 | Camera Timeline / Preview contract freeze — ratified canonical spec (five laws, binary transport, explicit scope menu, one-shell lanes, 36px header) + six owner closures; supersedes conflicting P11.2/P11.3/P11.4 rows; implementation slices follow the P11.4 baseline | **in-progress — P12.1/P12.2 shipped; P12.3 current** | P11 | [2026-08-26-P12-camera-timeline-contract-freeze.md](2026-08-26-P12-camera-timeline-contract-freeze.md) |
