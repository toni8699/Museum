...
import { g2AutoBezierDocument, g2LineRectangleDocument } from '$lib/layout/__fixtures__/layout-g2-fixtures';
...
import { buildPlanInteractionProjection } from './plan-overlays';
