...
**Status:** Active release authority. Phase 3 is complete through Slice 3.4.
**Baseline:** `main` at `8a36e28`; Phase 3.4 is uncommitted. Preserve it. Do not commit unless requested.
