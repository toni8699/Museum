...
| P3B | Scene|Camera × Plan|3D orientation interaction, Plan-surface parity, camera preview affordances, and deferred P3.4/P3.5 acceptance tail | in-progress — Group A + Group B (P3B.1–P3B.4) shipped 2026-08-24/25 and extracted to [archive](archive/plans/2026-08-24-P3B-groups-a-b-shipped.md); live doc slimmed; next Group C (P3B.5–P3B.6) → QA → deferred | P3 + P8 | [2026-08-24-P3B-orientation-preview-affordances.md](2026-08-24-P3B-orientation-preview-affordances.md) |
