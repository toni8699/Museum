...
import type { CameraConnectionDirection, MuseumConnection } from '$lib/types/museum';
...
function findConnection(graph: NavigationGraph, connectionId: string): MuseumConnection {
