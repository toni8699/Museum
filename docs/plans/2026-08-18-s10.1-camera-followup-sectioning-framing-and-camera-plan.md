...
S2/S3/S4 "S9/S11" boundary points are deferred post-H1).
...
step) → post-H1 work. The renewal doc's Hard-gate section records this.
...
2. **H1 vs post-H1 classification — resolved 2026-08-18.** The redesign lands
...
Increment IDs map to S10.3 increments: **B1 → S10.3.1**, **B2 → S10.3.2**
(+B3 folded in), **A0–A2 → the parallel engine track**, **A3 → S10.3.3**,
polish → **S10.3.4**. C0/B0 close S10.1 and are not part of S10.3.
