...
| P3B | Scene|Camera × Plan|3D orientation interaction, Plan-surface parity, camera preview affordances, and deferred P3.4/P3.5 acceptance tail | in-progress — P3B.1–P3B.6 shipped 2026-08-24/25; P11 is next, before P3B.7a/P3B.8 preview QA | P3 + P8 | [2026-08-24-P3B-orientation-preview-affordances.md](2026-08-24-P3B-orientation-preview-affordances.md) |
...
| P12 | Camera Timeline / Preview contract freeze — ratified canonical spec (five laws, binary transport, explicit scope menu, one-shell lanes, 36px header) + six owner closures; supersedes conflicting P11.2/P11.3/P11.4 rows; implementation slices follow the P11.4 baseline | **in-progress — P12.1/P12.2/P12.3 shipped 2026-08-27; P12.4 next** | P11 | [2026-08-26-P12-camera-timeline-contract-freeze.md](2026-08-26-P12-camera-timeline-contract-freeze.md) |
